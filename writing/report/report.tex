...
The linear model without memory and the one with concatenated features were trained with the \texit{RidgeCV} estimator from \textbf{scikit-learn}\autocite{scikitLearn}.
...
\todo{check this definition for correctness!}
